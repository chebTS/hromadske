...
public class SystemUtils {
	...
	/*dev AIzaSyAn9DDnBL7i6Chq2myHvU3YQEGVnGtDJlA
	...
	public static final String GDATA_URL = 
			"http://gdata.youtube.com/feeds/api/users/HromadskeTV/live/events?v=2&status=active&fields=entry(content)&alt=json"; 
